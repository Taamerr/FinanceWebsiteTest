...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
			$finance_accounting_comments_number = get_comments_number();
			if ( '1' === $finance_accounting_comments_number ) {
				...
				printf(
				    esc_html(
				       /* translators: 1: number of comments, 2: post title */
				           ...
				           $finance_accounting_comments_number,
				           'comments title',
				           'finance-accounting'
				        )
				    ),
				    esc_html (number_format_i18n( $finance_accounting_comments_number ) ),
